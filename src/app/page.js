...
export default function Home() {
  ...
  return (
   ...
   <div className="2xl:container mx-auto overflow-hidden">
    ...
    >
      <Navbar/>
      <p className="mt-40 max-md:mt-40 text-[0.75rem] tracking-[2.4px]bg-[#BFA2F61A] manrope-medium px-4 inline py-1 border border-[#BFA2F633] bg-clip-text text-transparent rounded-lg" 
      ...
      <AnimatedText className="bg-clip-text text-transparent text-center text-5xl md:text-6xl manrope-medium gradient-3 lg:px-40" text="Exchange Your Crypto Instantly, Anytime, Anywhere You Want" as="h1"/>
       ...
       <div className="w-[85%] mx-auto gradient-9 p-4 md:p-10 rounded-xl relative overflow-hidden">
        ...
        <div className="flex items-center flex-wrap justify-between">
          ...
          className="flex flex-col gap-3 w-full md:w-[48%]">
            ...
            <h2 className="text-3xl md:text-5xl manrope-medium tracking-[-1.92px] text-white">Live Bitcoin Price</h2>
            <p className="manrope-medium text-base md:text-[1.1rem] text-white">Stay updated with the latest Bitcoin market rate before making your exchange.</p>
            <div className="flex flex-col gap-2">
              <p className="flex items-center gap-4 text-base manrope-semibold bg-[#20232D] text-white py-4 px-6 rounded-lg">
                <span>
        ...
        <div className="flex flex-row-reverse items-center flex-wrap justify-between mt-8 relative z-10">
          <div className="flex flex-col gap-3 w-full md:w-[48%]">
            ...
            <h2 className="text-3xl md:text-5xl manrope-medium tracking-[-1.92px] text-white">Instant Bitcoin Exchange</h2>
            <p className="manrope-medium text-base md:text-[1.1rem] text-white">Quickly convert Bitcoin into your desired currency with fast and secure transactions.</p>
            <div className="flex flex-col gap-2">
              <p className="flex items-center gap-4 text-base manrope-semibold bg-[#20232D] text-white py-4 px-6 rounded-lg">
                <span>
      ...
      <div className="w-[85%] mx-auto flex items-center justify-between flex-wrap gap-y-6 relative z-100">
         ...
         <div className="w-full md:w-[49%] flex max-md:flex-col items-center gap-2 bg-[#14161B] rounded-lg">
          ...
          <div className="p-4">
            ...
            <p className="text-base manrope-regular text-white">Get the best market rate instantly with real-time price tracking.</p>
          </div>
        </div>
        ...
        <div className="w-full md:w-[49%] flex max-md:flex-col items-center gap-2 bg-[#14161B] rounded-lg">
          ...
          <div className="p-4">
            <h4 className="manrope-bold text-2xl md:text-3xl mb-2 text-white">5-minute transactions</h4>
            <p className="text-base manrope-regular text-white">Exchange Bitcoin and other cryptos in just minutes.</p>
          </div>
        </div>
          ...
          <div className="p-4">
            <h4 className="manrope-bold text-2xl md:text-3xl mb-2 text-white">No need for an account</h4>
            <p className="text-base manrope-regular text-white">Trade instantly without registration or sign-up.</p>
          </div>
        </div>
          ...
          <div className="p-4">
            <h4 className="manrope-bold text-2xl md:text-3xl mb-2 text-white">No limits on exchange</h4>
            <p className="text-base manrope-regular text-white">Convert over 300+ cryptocurrencies with no limits.</p>
          </div>
        </div>
          ...
          <div className="p-4">
            <h4 className="manrope-bold text-2xl md:text-3xl mb-2 text-white">We never hold your money</h4>
            <p className="text-base manrope-regular text-white">Your funds go directly to your wallet after exchange.</p>
          </div>
        </div>
          ...
          <div className="p-4">
            <h4 className="manrope-bold text-2xl md:text-3xl mb-2 text-white">Support in 10 sec</h4>
            <p className="text-base manrope-regular text-white">Get help from our team in seconds, anytime.</p>
          </div>
        </div>
